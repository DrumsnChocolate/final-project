...
launcher = 'none'
load_from = 'work_dirs/setrvpt_vit-l_pup_8xb2-160k_cbis-ddsm-binary-512x512/20240109_083737/iter_160000.pth'
log_level = 'INFO'
...
optim_wrapper = dict(
    clip_grad=None,
    optimizer=dict(lr=0.0005, momentum=0.9, type='SGD', weight_decay=0.001),
...
train_log_dir = 'work_dirs/setrvpt_vit-l_pup_8xb2-160k_cbis-ddsm-binary-512x512/20240109_083737'
train_pipeline = [
    dict(type='LoadImageFromFile'),
    dict(reduce_zero_label=False, type='LoadAnnotations'),
    dict(keep_ratio=True, scale=(
...
work_dir = 'work_dirs/setrvpt_vit-l_pup_8xb2-160k_cbis-ddsm-binary-512x512/20240109_083737/val'
