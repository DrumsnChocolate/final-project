...
launcher = 'none'
load_from = 'work_dirs/setrvpt_vit-l_pup_8xb2-160k_cbis-ddsm-binary-512x512/20240107_190223/iter_160000.pth'
log_level = 'INFO'
...
train_log_dir = 'work_dirs/setrvpt_vit-l_pup_8xb2-160k_cbis-ddsm-binary-512x512/20240107_190223'
train_pipeline = [
    dict(type='LoadImageFromFile'),
    dict(reduce_zero_label=False, type='LoadAnnotations'),
    dict(keep_ratio=True, scale=(
...
work_dir = 'work_dirs/setrvpt_vit-l_pup_8xb2-160k_cbis-ddsm-binary-512x512/20240107_190223/val'
