...
data_root = '/local/268255/data/cbis/cbis-linked'
...
train_cfg = dict(
    max_iters=220000, type='IterBasedTrainLoop', val_interval=22000)
...
work_dir = './work_dirs/unet-s5-d16_fcn-noaux_4xb4-220k_cbis-ddsm-mono-512x512'
