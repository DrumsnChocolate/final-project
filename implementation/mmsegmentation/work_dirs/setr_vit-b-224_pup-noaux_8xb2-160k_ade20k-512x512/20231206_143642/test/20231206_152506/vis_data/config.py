...
launcher = 'none'
load_from = '/home/drumsnchocolate/Documents/Studie/Master/2022-2023/Thesis/Final Project/implementation/mmsegmentation/work_dirs/setr_vit-b-224_pup-noaux_8xb2-160k_ade20k-512x512/20231206_143642/iter_160.pth'
log_level = 'INFO'
...
train_log_dir = 'work_dirs/setr_vit-b-224_pup-noaux_8xb2-160k_ade20k-512x512/20231206_143642'
train_pipeline = [
    dict(type='LoadImageFromFile'),
    dict(reduce_zero_label=True, type='LoadAnnotations'),
    dict(
