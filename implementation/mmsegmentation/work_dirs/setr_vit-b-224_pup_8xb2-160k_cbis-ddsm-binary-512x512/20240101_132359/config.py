...
default_hooks = dict(
    checkpoint=dict(
        by_epoch=False, interval=1600, max_keep_ckpts=2,
        type='CheckpointHook'),
...
train_cfg = dict(max_iters=1600, type='IterBasedTrainLoop', val_interval=1600)
...
work_dir = './work_dirs/setr_vit-b-224_pup_8xb2-160k_cbis-ddsm-binary-512x512'
