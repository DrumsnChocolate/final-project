...
launcher = 'none'
load_from = 'work_dirs/setrvpt_vit-l_pup-noaux_8xb2-220k_cbis-ddsm-mono-256x256/20240418_100829/epoch_1.pth'
log_level = 'INFO'
...
model = dict(
    ...
    backbone=dict(
        ...
        in_channels=3,
        init_cfg=dict(
            checkpoint='pretrain/vit_large_p16_224.pth', type='Pretrained'),
...
train_log_dir = 'work_dirs/setrvpt_vit-l_pup-noaux_8xb2-220k_cbis-ddsm-mono-256x256/20240418_100829'
train_pipeline = [
    dict(type='LoadImageFromFile'),
    dict(reduce_zero_label=True, type='LoadAnnotations'),
    dict(type='CLAHE'),
...
work_dir = 'work_dirs/setrvpt_vit-l_pup-noaux_8xb2-220k_cbis-ddsm-mono-256x256/20240418_100829/test'
