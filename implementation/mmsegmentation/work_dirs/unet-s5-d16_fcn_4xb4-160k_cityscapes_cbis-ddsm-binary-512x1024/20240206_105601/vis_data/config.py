...
default_hooks = dict(
    checkpoint=dict(
        by_epoch=False, interval=1, max_keep_ckpts=2, type='CheckpointHook'),
...
model = dict(
    ...
    backbone=dict(
        ...
        init_cfg=dict(
            checkpoint=
            'pretrain/fcn_unet_s5-d16_4x4_512x1024_160k_cityscapes_20211210_145204-6860854e.pth',
            prefix='backbone',
            type='Pretrained'),
        norm_cfg=dict(requires_grad=True, type='SyncBN'),
        norm_eval=False,
...
work_dir = './work_dirs/unet-s5-d16_fcn_4xb4-160k_cityscapes_cbis-ddsm-binary-512x1024'
