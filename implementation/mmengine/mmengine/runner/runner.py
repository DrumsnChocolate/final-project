...
from mmengine.model.base_module import get_param_count, get_param_count_trainable_recursively
...
class Runner:
    ...
    def __init__(
        ...
        # log parameter count info
        self.logger.info(f'Total parameters: {get_param_count(self.model)}')
        self.logger.info(f'Trainable parameters: {get_param_count_trainable_recursively(self.model)}')
        # wrap model
